...
# def get_lower_bound(tree_map: Tree, key: Key) -> Key:
#     root = tree_map.root
#
#     def recursion(root: TreeNode) -> Key:
#         if key > root.key:
#             if root.right:
#                 return recursion(root.right)
#             raise ValueError("No such big key in structure.")
#         elif key == root.key:
#             return root.key
...
#
#
# def get_upper_bound(tree_map: Tree, key: Key) -> Key:
#     root = tree_map.root
#
#     def recursion(root: TreeNode) -> Key:
#         if key == root.key:
...
#             return root.key
#         other_min_key_in_bound = recursion(root.left)
#         if key < other_min_key_in_bound.key < root.key:
#             return recursion(other_min_key_in_bound)
#
#     return recursion(root)
