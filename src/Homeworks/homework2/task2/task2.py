...
if __name__ == "__main__":
    ...
    while not os.path.exists(file_path_in):
        file_path_in = input("Путь до файла, подлежащего анализу, некорректный, попробуйте ещё раз:\n")
    ...
    while not os.path.exists(file_path_out):
        file_path_out = input("Введите путь до файла, в который нужно передать результаты анализа, некорректный, попробуйте ещё раз:\n")
